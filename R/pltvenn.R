...
#' )
#' pltvenn(dt, group.by = "group", proteincol.id = "id")
#'
#' @export
#' 
pltvenn= function(dat_long, group.by = "sample", proteincol.id = "Accession",fill.alpha=0.3){
  ...
  #绘
  proteins_venn <- plot(eulerr::euler(list_proteins, shape = "circle"), # ellipse   circle
